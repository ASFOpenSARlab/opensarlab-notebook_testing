...
test_data_path = "/home/jovyan/notebooks/asf_jupyter_notebook_testing/data_lab_6"
...
"""
test.add_test("subprocess.check_call(['aws', 's3', 'cp',  deformation_map_path, deformation_map])",
                   test_s3_copy)
...
"""
test.add_test("observed_deformation_map = np.reshape(coh, (line, sample))",
                   test_observed_deformation_map)
...
"""
test.add_test("observed_deformation_map[where_are_NaNs] = 0",
                   test_observed_deformation_map_nans)
...
"""
test.add_test("observed_deformation_map_m = np.ma.masked_where(observed_deformation_map==0, observed_deformation_map)",
                   test_observed_deformation_map_m)
...
"""
test.add_test("product_path = 'plots'",
                   test_product_path)
...
"""
test.add_test("output_filename='Okmok-inflation-observation.png', dpi=200)",
                   test_Okmok_inflation_observation_png)
...
"""
test.add_test("plt.savefig('Model-samples-3by3.png', dpi=200, transparent='false')",
                   test_Model_samples_3by3_png) 
...
"""
test.add_test("plt.savefig('Misfit-samples-3by3.png', dpi=200, transparent='false')",
                   test_Misfit_samples_3by3_png) 
...
"""
test.add_test("mmf = np.where(misfit == np.min(misfit))",
                   test_mogi_source_location)
...
"""
test.add_test("plt.savefig('Misfit-function.png', dpi=200, transparent='false')",
                   test_Misfit_function_png) 
...
"""
test.add_test("plt.savefig('BestFittingMogiDefo.png', dpi=200, transparent='false')",
                   test_BestFittingMogiDefo_png) 
...
"""
test.add_test("plt.savefig('Residuals-ObsMinusMogi.png', dpi=200, transparent='false')",
                   test_Residuals_ObsMinusMogi_png) 
