...
notebook_pth = ("/home/jovyan/opensarlab-notebooks/SAR_Training/English/Ecosystems/"
...
test_histogram = """
if os.path.exists(f"{path}/{product_path}/{figname}"):
    test.log_test('p', f"{path}/{product_path}/{figname} found")
else:
    test.log_test('f', f"{path}/{product_path}/{figname} NOT found")
"""
test.add_test_cell("plt.savefig(f\"{product_path}/{figname}\"", test_histogram)
