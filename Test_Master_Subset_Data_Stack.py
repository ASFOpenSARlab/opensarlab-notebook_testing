...
test_download = "!aws --region=us-east-1 --no-sign-request s3 cp s3://asf-jupyter-data/notebook_testing_data/jamalpur_stack_testing.zip opensarlab-notebook_testing/notebook_testing_dev/data_Test_Subset_Data_Stack/jamalpur_stack_testing.zip"
