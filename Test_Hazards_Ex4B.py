...
_to_replace = 'path = Path("/home/jovyan/notebooks/SAR_Training/English/Hazards/data_Ex4B_SARTimeSeriesChangeDetection")'
_replacement = 'path = Path("/home/jovyan/opensarlab-notebook_testing/notebook_testing_dev/hazards_data_Ex4B_SARTimeSeriesChangeDetection")'
test.replace_line(_to_replace, _to_replace, _replacement)

# Erase data directory if already present
test_data_path = "/home/jovyan/opensarlab-notebook_testing/notebook_testing_dev/hazards_data_Ex4B_SARTimeSeriesChangeDetection"
try:
...
"""
test.add_test_cell("plt.savefig(product_path/'march2may_time_series_backscatter_profile'",
                   test_march2may_time_series_backscatter_profile_png)
...
"""
test.add_test_cell("plt.savefig(product_path/'june2feb_time_series_backscatter_profile'",
                   test_june2feb_time_series_backscatter_profile_png)
...
"""
test.add_test_cell("plt.savefig(product_path/'yearly_time_series_backscatter_profile'",
                   test_yearly_time_series_backscatter_profile_png)
...
"""
test.add_test_cell("plt.savefig(product_path/'overlapping_years_time_series_backscatter_profile'",
                   test_overlapping_years_time_series_backscatter_profile_png)
...
"""
test.add_test_cell("plt.savefig(product_path/'year2year_differencing_time_series'",
                   test_year2year_differencing_time_series_png)
...
"""
test.add_test_cell("plt.savefig(product_path/'original_vs_median_time_series'",
                   test_original_vs_median_time_series_png)
...
"""
test.add_test_cell("plt.savefig(product_path/'original_time_series_vs_mean_val'",
                   test_original_time_series_vs_mean_val_png)
...
"""
test.add_test_cell("plt.savefig(product_path/'median_time_series_vs_mean_val'",
                   test_median_time_series_vs_mean_val_png)
...
"""
test.add_test_cell("plt.savefig(product_path/'cumulative_sum_residuals'",
                   test_cumulative_sum_residuals_png)
...
"""
test.add_test_cell('plt.savefig(product_path/f"detrended_time_series"',
                  test_detrended_time_series_png)
...
"""
test.add_test_cell('plt.savefig(product_path/f"globalMeans_original_detrended_time_series',
                  test_globalMeans_original_detrended_time_series_png)
...
"""
test.add_test_cell('plt.savefig(product_path/f"cumualtive_sum_detrended_time_series"',
                  test_cumualtive_sum_detrended_time_series_png)
...
"""
test.add_test_cell("plt.savefig(product_path/'band_1.png',", test_band_1_png)
...
"""
test.add_test_cell("plt.savefig(product_path/'raster_stack_mean.png'", test_raster_stack_mean_png)
...
"""
test.add_test_cell("geotiff_from_plot(raster_stack_mean, product_path/'raster_stack_mean', coords, utm_zone, cmap='gray', dpi=600)", test_raster_stack_mean_tiff)
...
"""
test.add_test_cell("plt.savefig(product_path/'residuals_band_1'", test_residuals_band_1_png)
...
"""
test.add_test_cell("geotiff_from_plot(residuals[0], product_path/'residuals_band_1', coords, utm_zone, dpi=600)", test_residuals_band_1_tiff)
...
"""
test.add_test_cell("plt.savefig(product_path/'Sdiff_histogram_CDF'", test_Sdiff_histogram_CDF_png)
...
"""
test.add_test_cell("plt.savefig(product_path/'change_candidate'", test_change_candidate_png)
...
"""
test.add_test_cell("plt.savefig(product_path/'masked_Smax_Smin_Sdiff'", 
                   test_masked_Smax_Smin_Sdiff_png)
...
"""
test.add_test_cell("plt.savefig(product_path/'confidence_change_point', dpi=300, transparent='true')", 
                   test_confidence_change_point_png)
...
"""
test.add_test_cell("geotiff_from_plot(confidence_level*change_point_significance, product_path/'CL_x_CP', coords, utm_zone)", 
                   test_CL_x_CP_tiff)
...
"""
test.add_test_cell("plt.savefig(product_path/'change_point_thresh',", 
                   test_change_point_thresh_png)
...
"""
test.add_test_cell("plt.savefig(product_path/'change_dates',", 
                   test_change_dates_png)
