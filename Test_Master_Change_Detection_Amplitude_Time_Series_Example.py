...
# Verify creation of the working directory
test_working_dir = """
...
"""
test.add_test_cell('if not path.is_dir():', test_working_dir)
...
"""
test.add_test_cell("plt.savefig(f'{product_path}/time_series_means.png', dpi=72)", test_times_series_means)
...
test_band_43_png = """
if Path(f"{product_path}/band_43.png"):
...
"""
test.add_test_cell("plt.savefig(f'{product_path}/time_series_backscatter_profile', dpi=72)", 
                   test_time_series_backscatter_profile_png)
...
"""
test.add_test_cell("plt.savefig(f'{product_path}/march2may_time_series_backscatter_profile', dpi=72)",
                   test_march2may_time_series_backscatter_profile_png)
...
"""
test.add_test_cell("plt.savefig(f'{product_path}/june2feb_time_series_backscatter_profile', dpi=72)",
                   test_june2feb_time_series_backscatter_profile_png)
...
"""
test.add_test_cell("plt.savefig(f'{product_path}/yearly_time_series_backscatter_profile', dpi=72)",
                   test_yearly_time_series_backscatter_profile_png)
...
"""
test.add_test_cell("plt.savefig(f'{product_path}/overlapping_years_time_series_backscatter_profile', dpi=72)",
                   test_overlapping_years_time_series_backscatter_profile_png)
...
"""
test.add_test_cell("plt.savefig(f'{product_path}/year2year_differencing_time_series', dpi=72)",
                   test_year2year_differencing_time_series_png)
...
"""
test.add_test_cell("plt.savefig(f'{product_path}/original_vs_median_time_series', dpi=72)",
                   test_original_vs_median_time_series_png)
...
"""
test.add_test_cell("plt.savefig(f'{product_path}/original_time_series_vs_mean_val', dpi=72)",
                   test_original_time_series_vs_mean_val_png)
...
"""
test.add_test_cell("plt.savefig(f'{product_path}/median_time_series_vs_mean_val', dpi=72)",
                   test_median_time_series_vs_mean_val_png)
...
"""
test.add_test_cell("plt.savefig(f'{product_path}/cumulative_sum_residuals', dpi=72)",
                   test_cumulative_sum_residuals_png)
...
"""
test.add_test_cell('plt.savefig(f"{product_path}/global_means_time_series", dpi=72)',
                  test_global_means_time_series_png)
...
"""
test.add_test_cell('plt.savefig(f"{product_path}/detrended_time_series", dpi=72)',
                  test_detrended_time_series_png)
...
"""
test.add_test_cell('plt.savefig(f"{product_path}/globalMeans_original_detrended_time_series", dpi=72)',
                  test_globalMeans_original_detrended_time_series_png)
...
"""
test.add_test_cell('plt.savefig(f"{product_path}/cumualtive_sum_detrended_time_series", dpi=72)',
                  test_cumualtive_sum_detrended_time_series_png)
...
"""
test.add_test_cell("plt.savefig(f'{product_path}/band_1.png', dpi=300, transparent='true')", test_band_1_png)
...
"""
test.add_test_cell("geotiff_from_plot(raster_stack[0], f'{product_path}/band_1', coords, utm_zone, cmap='gray', dpi=600)", test_band_1_tiff)
...
"""
test.add_test_cell("plt.savefig(f'{product_path}/raster_stack_mean.png', dpi=300, transparent='true')", test_raster_stack_mean_png)
...
"""
test.add_test_cell("plt.savefig(f'{product_path}/residuals_band_1', dpi=300, transparent='true')", test_residuals_band_1_png)
...
"""
test.add_test_cell("plt.savefig(f'{product_path}/Smax_Smin_Sdiff', dpi=300, transparent='true')", test_Smax_Smin_Sdiff_png)
...
"""
test.add_test_cell("geotiff_from_plot(sums_max, f'{product_path}/Smax', coords, utm_zone, vmin=vmin, vmax=vmax)", test_Smax_tiff)
...
"""
test.add_test_cell("geotiff_from_plot(sums_min, f'{product_path}/Smin', coords, utm_zone, vmin=vmin, vmax=vmax)", test_Smin_tiff)
...
"""
test.add_test_cell("geotiff_from_plot(change_mag, f'{product_path}/Sdiff', coords, utm_zone, vmin=vmin, vmax=vmax)", test_Sdiff_tiff)
...
"""
test.add_test_cell("plt.savefig(f'{product_path}/Sdiff_histogram_CDF', dpi=72, transparent='true')", test_Sdiff_histogram_CDF_png)
...
"""
test.add_test_cell("plt.savefig(f'{product_path}/change_candidate', dpi=300, transparent='true')", test_change_candidate_png)
...
"""
test.add_test_cell("geotiff_from_plot(change_mag_mask, f'{product_path}/change_candidate', coords, utm_zone, cmap='gray')",
                   test_change_candidate_tiff)
...
"""
test.add_test_cell("plt.savefig(f'{product_path}/masked_Smax_Smin_Sdiff', dpi=300, transparent='true')", 
                   test_masked_Smax_Smin_Sdiff_png)
...
"""
test.add_test_cell("geotiff_from_plot(sums_masked_max, f'{product_path}/masked_Smax', coords, utm_zone, vmin=vmin, vmax=vmax)",
                   test_masked_Smax_tiff)
...
"""
test.add_test_cell("geotiff_from_plot(sums_masked_min, f'{product_path}/masked_Smin', coords, utm_zone, vmin=vmin, vmax=vmax)",
                   test_masked_Smin_tiff)
...
"""
test.add_test_cell("geotiff_from_plot(change_mag, f'{product_path}/masked_Sdiff', coords, utm_zone, vmin=vmin, vmax=vmax)",
                   test_masked_Sdiff_tiff)
...
"""
test.add_test_cell("plt.savefig(f'{product_path}/confidence_change_point', dpi=300, transparent='true')", 
                   test_confidence_change_point_png)
...
"""
test.add_test_cell("geotiff_from_plot(confidence_level*100, f'{product_path}/confidence_level', coords, utm_zone)", 
                   test_confidence_level_tiff)
...
"""
test.add_test_cell("geotiff_from_plot(change_point_significance, f'{product_path}/change_point', coords, utm_zone)", 
                   test_confidence_level_tiff)
...
"""
test.add_test_cell("plt.savefig(f'{product_path}/change_point_thresh', dpi=300, transparent='true')", 
                   test_change_point_thresh_png)
...
"""
test.add_test_cell("f'{product_path}/change_point_thresh', coords, utm_zone, cmap='cool')", 
                   test_change_point_thresh_tiff)
...
"""
test.add_test_cell("plt.savefig(f'{product_path}/change_dates', dpi=300, transparent='true')", 
                   test_change_dates_png)
...
"""
test.add_test_cell("geotiff_from_plot(change_point_index, f'{product_path}/change_dates', coords, utm_zone, interpolation='nearest', cmap=cmap)", 
                   test_change_dates_tiff)
